...
تكتب عربية واضحة بدون Markdown. الدقة أهم من الاختصار.
اعتمادك فقط على نتائج الفحص الآلي المرفقة ومرجع مكتب المحاسبة وسياسة الشركة وكشوف الحساب المرفوعة أدناه.

أخرج تقريراً مهنياً بهذا الترتيب:
...
ممنوع اختراع مستندات أو أرصدة غير موجودة.
