/**
 * Capture Mega wave-1 sales/purchases PDFs (short date range + عرض).
...
const REPORTS = [
  { key: "sales", featureKey: "accountingreports-sales", path: "/AccountingReports/Sales.aspx" },
  { key: "customers-sales", featureKey: "accountingreports-customerssales", path: "/AccountingReports/CustomersSales.aspx" },
  { key: "gross-customer-sales-by-items", featureKey: "accountingreports-grosscustomersalesbyitems", path: "/AccountingReports/GrossCustomerSalesByItems.aspx" },
  { key: "purchases", featureKey: "accountingreports-purchases", path: "/AccountingReports/Purchases.aspx" },
  { key: "vendors-purchases", featureKey: "accountingreports-vendorspurchases", path: "/AccountingReports/VendorsPurchases.aspx" },
  { key: "gross-vendor-purchases-by-items", featureKey: "accountingreports-grossvendorpurchasesbyitems", path: "/AccountingReports/GrossVendorPurchasesByItems.aspx" },
];
...
(async () => {
  ...
  fs.writeFileSync(path.join(OUT, "wave1-pdf-capture.json"), JSON.stringify({ at: new Date().toISOString(), results }, null, 2));
