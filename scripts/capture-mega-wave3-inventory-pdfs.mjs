/**
 * Capture Mega wave-3 inventory PDFs (short date range + عرض).
...
const OUT = "artifacts/mega-wave3-inventory/pdf";
...
const REPORTS = [
  { key: "inventory-summary", featureKey: "invreports-inventorysummary", path: "/InvReports/InventorySummary.aspx" },
  { key: "items-transfer-details", featureKey: "invreports-itemstransferdetails", path: "/InvReports/ItemsTransferDetails.aspx" },
  { key: "warehouse-export-import", featureKey: "invreports-totalinventoryexportimportreport", path: "/InvReports/TotalInventoryExportImportReport.aspx" },
  { key: "inventory-transfer-details", featureKey: "invreports-inventorytransferdetailsreport", path: "/InvReports/InventoryTransferDetailsReport.aspx" },
  { key: "items-costs", featureKey: "invreports-itemscosts", path: "/InvReports/ItemsCosts.aspx" },
  { key: "items-list", featureKey: "invreports-itemslist", path: "/InvReports/ItemsList.aspx" },
  { key: "items-summary", featureKey: "invreports-itemssummary", path: "/InvReports/ItemsSummary.aspx" },
  { key: "income-outcome-item", featureKey: "invreports-incomeoutcomeitem", path: "/InvReports/IncomeOutcomeItem.aspx" },
  { key: "stagnant-items", featureKey: "invreports-stagnantitems", path: "/InvReports/StagnantItems.aspx" },
];
  ...
  const onResponse = async (res) => {
    try {
      ...
      const interesting =
        ...
        /pdf/i.test(ct) ||
        (method === "POST" && /InvReports\/.+\.aspx/i.test(url));
...
(async () => {
  ...
  fs.writeFileSync(path.join(OUT, "wave3-pdf-capture.json"), JSON.stringify({ at: new Date().toISOString(), results }, null, 2));
