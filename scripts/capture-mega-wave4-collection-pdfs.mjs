/**
 * Capture Mega wave-4 collection/accounting leftovers PDFs (short date range + عرض).
...
const OUT = "artifacts/mega-wave4-collection/pdf";
...
const REPORTS = [
  { key: "checks-out", featureKey: "accountingreports-checks-checkout", path: "/AccountingReports/Checks.aspx/CheckOut" },
  { key: "checks-in", featureKey: "accountingreports-checks-checkin", path: "/AccountingReports/Checks.aspx/CheckIn" },
  { key: "customers-installments", featureKey: "accountingreports-customersinstallments", path: "/AccountingReports/CustomersInstallments.aspx" },
  { key: "payments", featureKey: "accountingreports-payments", path: "/AccountingReports/Payments.aspx" },
  { key: "dues", featureKey: "accountingreports-dues", path: "/AccountingReports/Dues.aspx" },
  { key: "account-statement-cash", featureKey: "accountingreports-accountstatment-cash", path: "/AccountingReports/AccountStatment.aspx/Cash" },
  { key: "cost-center-statement", featureKey: "accountingreports-costcenterstatment", path: "/AccountingReports/CostCenterStatment.aspx" },
  { key: "dashboard", featureKey: "accountingreports-dashboard", path: "/AccountingReports/Dashboard.aspx" },
  { key: "branches-summary", featureKey: "accountingreports-branchessummary", path: "/AccountingReports/BranchesSummary.aspx" },
  { key: "monthly-expenses", featureKey: "accountingreports-monthlyexpenses", path: "/AccountingReports/MonthlyExpenses.aspx" },
];
  ...
  const onResponse = async (res) => {
    try {
      ...
      const interesting =
        ...
        /pdf/i.test(ct) ||
        (method === "POST" && /(?:Inv|Accounting)Reports\/.+\.aspx/i.test(url));
...
(async () => {
  ...
  fs.writeFileSync(path.join(OUT, "wave4-pdf-capture.json"), JSON.stringify({ at: new Date().toISOString(), results }, null, 2));
