...
export const PERMISSION_TREE: PermModule[] = [
  {
    ...
    entities: [
      ...
      { key: "pendingDocs", label: "المستندات المعلقة", bundle: "REPORT", extra: ["viewDocList"] },
      ...
      { key: "openPreviousPeriod", label: "فتح فترة مالية سابقة", bundle: "REPORT", omit: ["allBranches"], extra: ["add"] },
      { key: "closePeriod", label: "إغلاق الفترة المالية", bundle: "REPORT", omit: ["allBranches"], extra: ["add"] },
      { key: "userActions", label: "حركات المستخدمين", bundle: "REPORT" },
      { key: "importData", label: "استيراد البيانات", bundle: "REPORT", omit: ["allBranches"], extra: ["add"] },
    ],
  },
  {
    key: "contacts",
  ...
  },
  {
    ...
    entities: [
      ...
      { key: "employeeTransactions", label: "معاملات الموظفين (السلف)", bundle: "BASIC4", extra: ["approve", "viewDocList"], omit: ["edit", "deleteCancel"] },
      { key: "employeeVacationRequests", label: "طلبات إجازات الموظفين", bundle: "BASIC4", extra: ["approve"] },
  ...
  },
  {
    ...
    entities: [
      ...
      { key: "serials", label: "الأرقام التسلسلية", bundle: "BASIC4_BRANCH" },
  ...
  },
  {
    ...
    label: "وارد العمليات",
    entities: [
      { key: "factoryDaily", label: "شغل المصنع اليومي", bundle: "BASIC4" },
      { key: "whatsappInbox", label: "وارد واتساب", bundle: "BASIC4" },
    ],
  },
  {
    key: "cost_centers",
