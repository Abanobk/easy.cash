...
export default function PurchaseOrders() {
  ...
  const [form, setForm] = useState({
    supplierId: "", warehouseId: "", date: new Date().toISOString().split("T")[0], notes: "", expectedDate: "",
    referenceNumber: "", phone: "", address: "",
  });
          ...
          <Table>
            ...
            <TableBody>
              {(!data?.rows || data.rows.length === 0) && (
                <TableRow><TableCell colSpan={7} className="text-center text-slate-400 py-10">لا توجد طلبات شراء</TableCell></TableRow>
              )}
