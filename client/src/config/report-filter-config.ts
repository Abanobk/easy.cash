...
const ACCOUNTING_FILTERS: Record<string, ReportEntityFilter[]> = {
  ...
  "accountingreports-itemsprofits": ["item", "category", "branch", "customer", "rep", "area", "warehouse"],
  "accountingreports-customersprofits": ["customer", "branch", "area", "rep"],
  "accountingreports-invoiceprofits": ["customer", "branch", "rep", "area", "item", "category", "warehouse"],
